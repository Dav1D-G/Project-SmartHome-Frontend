...
{
    return(
        <Flex backgroundColor={`#B0AFE5`} height={'80px'} display={{base : 'flex' , lg : 'none'}}>
            <Flex flex={1} alignItems={'center'}>
                <Box ms={'2'} onClick={()=>setIsClickedBurger(()=>!isClickedBurger)}>
                    <Image src={`${burger_menu}`} width={'60px'} height={'60px'}  border={`${isClickedBurger ? "1px" : ''}`} borderColor={'gray.200'} borderRadius={'10px'}/>
                </Box>
            </Flex>
